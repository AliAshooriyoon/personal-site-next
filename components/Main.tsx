    ...
    <>
      <div className="flex pt-20 md:px-36 md:pb-36 gap-16 w-full justify-around max-md:flex-col-reverse max-md:gap-12">
        ...
        <div className="picture_box max-sm:w-full  max-sm:flex justify-center items-center">
          <div className="w-72  max-sm:w-60 max-[320px]:w-52 h-96 mx-auto  bg-[#023E6F] rounded-2xl md:-rotate-14">
            <div className="relative max-[320px]:w-52 max-sm:right-1/2 max-sm:left-1/2 max-sm:-translate-x-1/2 max-sm:w-[99%]  w-72 h-96 bg-stone-400 rounded-2xl md:rotate-14 overflow-hidden">
